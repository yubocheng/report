...
displaying in R using delayed matrix, minimal data needs to be brought into R. 
This design fastens matrix data manapulation, including subset, binding, etc.
...
construction of displaying assay data with DelayedArray class reduces 
